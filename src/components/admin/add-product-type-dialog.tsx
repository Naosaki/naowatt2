...
export function AddProductTypeDialog({ onProductTypeAdded, open, onOpenChange }: AddProductTypeDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Créer un nouvel objet type de produit
      ...
      // Ajouter le type de produit à Firestore
    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      {!open && (
        <DialogTrigger asChild>
          <Button>Ajouter un type de produit</Button>
        </DialogTrigger>
      )}
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Ajouter un nouveau type de produit</DialogTitle>
          <DialogDescription>
            Créez un nouveau type de produit pour organiser vos documents.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                placeholder="ex: Panneau Solaire"
                required
              />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">

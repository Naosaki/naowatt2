...
export function toast({
  ...
  toastElement.className = `fixed bottom-4 right-4 z-50 rounded-md border p-4 shadow-md ${variant === 'destructive' ? 'bg-destructive text-destructive-foreground' : 'bg-background text-foreground'}`;
